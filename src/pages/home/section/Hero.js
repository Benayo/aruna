...
const Hero = () => {
  return (
    <div className="relative bg-hero-mobile-background md:bg-hero-background bg-cover bg-center bg-no-repeat min-h-[90vh] flex justify-start items-center px-4 md:px-16">
      <div className="absolute inset-0 bg-gradient-to-r from-[#040704cc] to-transparent md:from-[#04070499] md:to-transparent z-10"></div>
